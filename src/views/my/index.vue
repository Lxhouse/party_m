  ...
  <div class="my-container">
    <van-cell-group class="my-info" v-if="user">
      <van-cell class="base-info" center :border="false">
        ...
        <van-button class="update-btn" size="small" round>党员信息</van-button>
      </van-cell>
    ...
    <div class="not-login" v-else>
      <div @click="$router.push('/login')">
        <img class="mobile" src="../../../public/img/mobile.png" />
      </div>
    ...
    <van-cell class="mb-4" title="党讯快问" is-link to="/user/chat" />
    <van-cell
      v-if="user"
      class="logout-cell"
      title="退出登录"
